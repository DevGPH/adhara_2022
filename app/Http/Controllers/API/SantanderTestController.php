    ...
    public function index($folio)
    {
        ...
        if($reserva != null)
        {
            ...
            else
            {
                ...
                dd($sxe, $descrypted_xml, Crypt::decryptString($keys['id_company']), Crypt::decryptString($keys['user']), Crypt::decryptString($keys['id_sucursal']), Crypt::decryptString($keys['pass_user']) );
