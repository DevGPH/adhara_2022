...
<div class="row py-4" style="margin-bottom:500px;">
    <div class="col-12 mb-4">
        <div class="card border-0 shadow" style="background-color: #fac0b9">
            <div class="card-header d-sm-flex flex-row align-items-center flex-0">
                <div class="d-block mb-3 mb-sm-0">
                    <div class="fs-5 fw-normal mb-2">Valor en Ventas</div>
                    <h2 class="fs-3 fw-extrabold">${{ number_format($total,2) }} MXN</h2>
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        ...
                        <h3 class="fw-extrabold mb-1">{{ number_format($huespedes,2) }}</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">Clientes</h2>
                            <h3 class="fw-extrabold mb-2">{{ $huespedes }}</h3>
                        </div>
