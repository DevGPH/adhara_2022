...
<body>
    <div style="width: 800px;display:block;margin:0 auto;">
        <div style="padding:10px;">
            ...
            <p style="margin-left: 40px;">Reservacion Fallida</p>
            ...
            <hr style="border-bottom-color: rgb(137, 44, 121);width:680px;">
            <p style="margin-top: 50px;">Tasa turística no incluida 79.20 MXN por habitación x noche a pagar en el hotel</p>
