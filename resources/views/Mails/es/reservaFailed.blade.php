...
<body>
    <div style="width: 800px;display:block;margin:0 auto;">
        <div style="padding:10px;">
            ...
            <p style="text-align: right;">Reserva Fallida</p>
            ...
            <p style="margin-left: 40px;">Detalle de la reservación</p>
            ...
            <hr style="border-bottom-color: rgb(137, 44, 121);width:680px;">
            <p style="margin-top: 50px;">Tasa turística no incluida 72.62 MXN por habitación x noche a pagar en el hotel</p>
