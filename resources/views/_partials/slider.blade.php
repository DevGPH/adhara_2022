    ...
    <div class="widget-slider">
        <div class="wrapper-full">
            ...
            <div class="slide-mob">
                <div class="widget-carousel owl-carousel owl-theme">
                    @if (App::getLocale() == 'es')
                        <div class="slider-item" data-background="{{ asset('images/sliders/mobile_es.png') }}"></div>
                    @else
                        <div class="slider-item" data-background="{{ asset('images/sliders/mobile_en.png') }}"></div>
                    @endif
                    <div class="slider-item" data-background="{{ asset('images/sliders/slider1.png') }}">
                        <div class="wrapper">
                            <div class="item-inner">
