                ...
                <div class="widget-carousel owl-carousel owl-theme">
                    <div class="testimonials-item">
                        <div class="item-comment">
                            Un paraíso inesperado en medio de Cancún.
                            Está muy bien cuidado y muy limpio. La piscina es increíble y te olvidas de que estás en un barrio común y corriente. El desayuno es simplemente el mejor, con una enorme variedad para elegir.
                        </div>
                        <div class="item-customer">
                            <div class="customer-photo" data-background="{{ asset('images/utilities/mike.png') }}"></div>
                            <h5>Mike</h5>
                            <h6>GB</h6>
                        </div>
                    </div>
                    ...
                    <div class="testimonials-item">
                        <div class="item-comment">
                            Personal 10, Instalaciones y servicios 10, limpieza 10, confort 10, Ubicación 10, Relación calidad-precio 10.
                        </div>
                        <div class="item-customer">
                            <div class="customer-photo" data-background="{{ asset('images/utilities/santiago.png') }}"></div>
                            <h5>Santiago</h5>
                            <h6>Co</h6>
                        </div>
                    </div>
                    <div class="testimonials-item">
                        <div class="item-comment">
                            Personal 10, Instalaciones y servicios 10, limpieza 10, confort 10, Ubicación 10, Relación calidad-precio 10, puntuación de la cama 7.5
                        </div>
                        <div class="item-customer">
                            <div class="customer-photo" data-background="{{ asset('images/utilities/gabriele.png') }}"></div>
                            <h5>Gabriele</h5>
                            <h6>Br</h6>
                        </div>
                    </div>
                    ...
                    <div class="testimonials-item">
                        <div class="item-comment">
                            Personal 10, Instalaciones y servicios 10, limpieza 10, confort 10, Ubicación 10, Relación calidad-precio 10, Adicional: Puntuación de la cama: 10
                            Todo excelente
                        </div>
                        <div class="item-customer">
                            <div class="customer-photo" data-background="{{ asset('images/utilities/enrique.png') }}"></div>
                            <h5>Enrique</h5>
                            <h6>MX</h6>
                        </div>
                    </div>
                    ...
                    <div class="testimonials-item">
                        <div class="item-comment">
                            Una estancia agradable, limpio y la mayoría del personal es muy amable y servicial. 
                            Hay comidas y bebidas frescas y disponibles. La piscina es una ventaja para los días calurosos.
                        </div>
                        <div class="item-customer">
                            <div class="customer-photo" data-background="{{ asset('images/utilities/kay.png') }}"></div>
                            <h5>Kay</h5>
                            <h6>Nueva Zelanda</h6>
                        </div>
                    </div>
                    <div class="testimonials-item">
                        <div class="item-comment">
                            Fuera del complejo hotelero, accesible en coche a cualquier lugar, merece la pena. El servicio del personal, la ubicación.
                        </div>
                        <div class="item-customer">
                            <div class="customer-photo" data-background="{{ asset('images/utilities/orit.png') }}"></div>
                            <h5>Orit</h5>
                            <h6>It</h6>
                        </div>
                    </div>
                    <div class="testimonials-item">
                        <div class="item-comment">
                            Personal 10, Instalaciones y servicios 10, limpieza 7, confort 10, Ubicación 7.5, Relación calidad-precio 7.5, Adicional: Puntuación de la cama: 10
                            Mucha variedad para desayunar, hotel grande. No hay mucho sol en la piscina al final de la tarde.
                        </div>
                        <div class="item-customer">
                            <div class="customer-photo" data-background="{{ asset('images/utilities/estelle.png') }}"></div>
                            <h5>Estelle</h5>
                            <h6>BE</h6>
                        </div>
                    </div>
