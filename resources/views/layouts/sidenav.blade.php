<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
  <div class="sidebar-inner px-2 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      <li class="nav-item">
        <a href="{{ route('inicio',['locale'=>'es']) }}" class="nav-link d-flex align-items-center">
      ...
      <li class="nav-item {{ Request::segment(2) == 'dashboard' ? 'active' : '' }}">
        <a href="{{ route('home',['locale'=>'es']) }}" class="nav-link">
      ...
      <li class="nav-item">
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
          ...
          <span>
            ...
            <span class="sidebar-text" style="color: #fb503b;">Reservas</span>
          </span>
        ...
        <div class="multi-level collapse" role="list" id="submenu-laravel" aria-expanded="false">
          <ul class="flex-column nav">
            <!--li class="nav-item {{ Request::segment(2) == 'profile' ? 'active' : '' }}">
              <a href="{{ route('reserva.admin',['locale' => 'es']) }}" class="nav-link">
                <span class="sidebar-text">Dar de Alta</span>
              </a>
            </li-->
            <li class="nav-item {{ Request::segment(2) == 'users' ? 'active' : '' }}">
              <a href="{{ route('reservas.admin',['locale' => 'es']) }}" class="nav-link">
                <span class="sidebar-text">Ver Reservas</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <li class="nav-item">
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
          ...
          <span>
            <span class="sidebar-icon"><i class="fab fa-laravel me-2" style="color: #fb503b;"></i></span>
            <span class="sidebar-text" style="color: #fb503b;">Temporadas</span>
          </span>
          <span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
        ...
        <div class="multi-level collapse" role="list" id="submenu-laravel2" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(2) == 'profile' ? 'active' : '' }}">
              <a href="{{ route('temporada.admin',['locale' => 'es']) }}" class="nav-link">
                <span class="sidebar-text">Dar de Alta</span>
              </a>
            </li>
            <li class="nav-item {{ Request::segment(2) == 'users' ? 'active' : '' }}">
              <a href="{{ route('temporadas.admin',['locale' => 'es']) }}" class="nav-link">
                <span class="sidebar-text">Ver Temporadas</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <li class="nav-item">
        <a href="{{ route('habitaciones.admin',['locale' => 'es']) }}" class="nav-link d-flex justify-content-between">
          <span>
            <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <span class="sidebar-text">Habitaciones </span>
          </span>
          <!--span>
      ...
      <li class="nav-item">
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
          data-bs-target="#submenu-stopsales" aria-expanded="false">
          <span>
            <span class="sidebar-icon"><i class="fab fa-laravel me-2" style="color: #fb503b;"></i></span>
            <span class="sidebar-text" style="color: #fb503b;">StopSales</span>
          </span>
          <span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
        ...
        <div class="multi-level collapse" role="list" id="submenu-stopsales" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(2) == 'profile' ? 'active' : '' }}">
              <a href="{{ route('stopsale.admin',['locale' => 'es']) }}" class="nav-link">
                <span class="sidebar-text">Dar de Alta</span>
              </a>
            </li>
            <li class="nav-item {{ Request::segment(2) == 'users' ? 'active' : '' }}">
              <a href="{{ route('stopsales.admin',['locale' => 'es']) }}" class="nav-link">
                <span class="sidebar-text">Ver StopSales</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <li class="nav-item">
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
          data-bs-target="#submenu-colaborador" aria-expanded="false">
          <span>
            <span class="sidebar-icon"><i class="fab fa-laravel me-2" style="color: #fb503b;"></i></span>
            <span class="sidebar-text" style="color: #fb503b;">Colaboradores</span>
          </span>
          <span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
        ...
        <div class="multi-level collapse" role="list" id="submenu-colaborador" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(2) == 'profile' ? 'active' : '' }}">
              <a href="{{ route('dashboard.users',['locale' => 'es']) }}" class="nav-link">
                <span class="sidebar-text">Ver Colaboradores</span>
              </a>
            </li>
            <li class="nav-item {{ Request::segment(2) == 'users' ? 'active' : '' }}">
              <a href="{{ route('create.user',['locale' => 'es']) }}" class="nav-link">
                <span class="sidebar-text">Dar de Alta</span>
              </a>
            </li>
          </ul>
      ...
      <li class="nav-item">
        <span
          class="nav-link {{ Request::segment(2) !== 'bootstrap-tables' ? 'collapsed' : '' }} d-flex justify-content-between align-items-center"
        ...
        <div class="multi-level collapse {{ Request::segment(2) == 'bootstrap-tables' ? 'show' : '' }}" role="list"
          id="submenu-app" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(2) == 'bootstrap-tables' ? 'active' : '' }}">
