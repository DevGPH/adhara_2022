        ...
        <div class="widget-page-title">
            ...
            <div class="wrapper-inner" style="padding: 0px;padding-top:30px;padding-bottom:30px;">
                <div class="box-staff" style="width: 400px;display:block;margin:auto;">
                    <h5 style="width:100%;text-align: center;margin-bottom:10px;"><strong>@lang('main.keep.touch')</strong></h5>
                    <p style="width:100%;text-align: center;margin-bottom:10px;margin-top:0px;">Hotel Adhara Cancún & Hotel Adhara Express</p>
