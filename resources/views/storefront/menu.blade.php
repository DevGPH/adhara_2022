...
<div class="site-main">
    @if ($lang == 'es')
        ...
        <img src="{{ asset('images/menus/licor2025_en.png') }}" alt="Menu del Restaurante" style="display:block;margin:0px auto;">
    @else
        ...
        <img src="{{ asset('images/menus/licor2025_es.png') }}" alt="Menu del Restaurante" style="display:block;margin:0px auto;">
    @endif
</div>
