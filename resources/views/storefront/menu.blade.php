...
<div style="margin-top:90px">
    @if ($lang == 'es')
        <img src="{{ asset('images/menus/menu_grill_en.png') }}" alt="Menu del Restaurante" class="img-fluid img-c">
    ...
    @else
        <img src="{{ asset('images/menus/menu_grill_es.png') }}" alt="Menu del Restaurante" class="img-fluid img-c">
