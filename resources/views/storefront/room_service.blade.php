...
<div style="margin-top: 90px;">
    @if ($lang == 'es')
        <img src="{{ asset('images/menus/room_service_menu_en.jpg') }}" alt="Menu del Restaurante" class="img-fluid img-c">
        <img src="{{ asset('images/menus/room_service_coco_en.jpg') }}" alt="Menu del Restaurante" class="img-fluid img-c">
    @else
        <img src="{{ asset('images/menus/room_service_menu_es.jpg') }}" alt="Room Service" class="img-fluid img-c">
