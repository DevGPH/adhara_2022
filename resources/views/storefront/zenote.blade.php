            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <video controls="controls" width="800" height="600" name="Video Name">
                        <source src="{{ asset('images/cenote/cenote1.mp4') }}" type="video/mp4">
                    </video>
                </div>
                <div class="item">
                    <video controls="controls" width="800" height="600" name="Video Name">
                        <source src="{{ asset('images/cenote/cenote2.mp4') }}" type="video/mp4">
                    </video>
                </div>
                <div class="item">
                    <video controls="controls" width="800" height="600" name="Video Name">
                        <source src="{{ asset('images/cenote/cenote3.mp4') }}" type="video/mp4">
                    </video>
                </div>
                <div class="item">
                    <video controls="controls" width="800" height="600" name="Video Name">
                        <source src="{{ asset('images/cenote/cenote4.mp4') }}" type="video/mp4">
                    </video>
                </div>
                <div class="item">
                    <video controls="controls" width="800" height="600" name="Video Name">
                        <source src="{{ asset('images/cenote/cenote5.mp4') }}" type="video/mp4">
                    </video>
                </div>
            </div>
